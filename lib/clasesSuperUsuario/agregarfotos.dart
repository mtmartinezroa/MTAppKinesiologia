...
class AgregarFotos extends StatefulWidget {
...
class _HomeState extends State<AgregarFotos> {
  ...
  Future elegirFoto() async { // funcion que elige el archivo que queremos subir a la bd
        ...
        child: Column(
          children: [
            ...
            ElevatedButton.icon( //boton para subir video
              ...
              label: const Text('Subir Foto a BD'),
            ),
            barraProgreso(),
          ],
        ),
